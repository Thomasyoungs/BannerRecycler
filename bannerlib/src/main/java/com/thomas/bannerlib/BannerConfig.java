...
public class BannerConfig {
    ...
    public static int PAGEPADDING = (int) (DP * 15);
    public static int CARDMARGINSTART = (int) (DP * 15);
    ...
    public static final float mIndicatorItemPadding = DP * 6;
    public static final int CIRCLE = 0;
    public static final int RECT = 1;
    public static final int mIndicatorType = RECT;
